...
enum
{
  rm_interfaces__srv__SetMode_Event__request__MAX_SIZE = 1
};
// response
enum
{
  rm_interfaces__srv__SetMode_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetMode in the package rm_interfaces.
typedef struct rm_interfaces__srv__SetMode_Event
{
  service_msgs__msg__ServiceEventInfo info;
  rm_interfaces__srv__SetMode_Request__Sequence request;
  rm_interfaces__srv__SetMode_Response__Sequence response;
} rm_interfaces__srv__SetMode_Event;

// Struct for a sequence of rm_interfaces__srv__SetMode_Event.
typedef struct rm_interfaces__srv__SetMode_Event__Sequence
{
