...
// IWYU pragma: private, include "rm_interfaces/msg/debug_light.h"


#ifndef RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHT__FUNCTIONS_H_
#define RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHT__FUNCTIONS_H_
 ...
 * calls
 * rm_interfaces__msg__DebugLight__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interfaces
rm_interfaces__msg__DebugLight *
rm_interfaces__msg__DebugLight__create(void);

/// Destroy msg/DebugLight message.
/**
 * It calls
 * rm_interfaces__msg__DebugLight__fini()
 ...
 * rm_interfaces__msg__DebugLight__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_interfaces__msg__DebugLight__Sequence__fini()
 * on the array,
...
#endif  // RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHT__FUNCTIONS_H_
