...
static const _SetMode_Event_type_support_symbol_names_t _SetMode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, srv, SetMode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, srv, SetMode_Event)),
  }
};
...
{
  return &::rm_interfaces::srv::rosidl_typesupport_cpp::SetMode_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rm_interfaces, srv, SetMode_Event)() {
  return get_message_type_support_handle<rm_interfaces::srv::SetMode_Event>();
}
...
static const rosidl_service_type_support_t SetMode_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rm_interfaces::srv::SetMode_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rm_interfaces::srv::SetMode_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<rm_interfaces::srv::SetMode_Event>(),
