...
{
public:
  explicit Init_SetMode_Event_response(::rm_interfaces::srv::SetMode_Event & msg)
  : msg_(msg)
  {}
  ::rm_interfaces::srv::SetMode_Event response(::rm_interfaces::srv::SetMode_Event::_response_type arg)
  {
...
private:
  ::rm_interfaces::srv::SetMode_Event msg_;
};

class Init_SetMode_Event_request
{
public:
  explicit Init_SetMode_Event_request(::rm_interfaces::srv::SetMode_Event & msg)
  : msg_(msg)
  {}
  Init_SetMode_Event_response request(::rm_interfaces::srv::SetMode_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetMode_Event_request info(::rm_interfaces::srv::SetMode_Event::_info_type arg)
  {
...
template<>
inline
auto build<::rm_interfaces::srv::SetMode_Event>()
{
  return rm_interfaces::srv::builder::Init_SetMode_Event_info();
}
