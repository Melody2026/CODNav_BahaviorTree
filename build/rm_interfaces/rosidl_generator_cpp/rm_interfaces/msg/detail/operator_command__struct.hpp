...
struct OperatorCommand_
{
  ...
  using _is_spin_type =
    uint8_t;
  _is_spin_type is_spin;
  using _is_buyshut_type =
    uint8_t;
  _is_buyshut_type is_buyshut;
  using _is_attackqs_type =
    uint8_t;
  _is_attackqs_type is_attackqs;
  ...
  Type & set__is_buyshut(
    const uint8_t & _arg)
  {
    this->is_buyshut = _arg;
    return *this;
  }
  Type & set__is_attackqs(
    const uint8_t & _arg)
  {
    this->is_attackqs = _arg;
    return *this;
  }
  ...
  bool operator==(const OperatorCommand_ & other) const
  {
    ...
    if (this->is_spin != other.is_spin) {
      return false;
    }
    if (this->is_buyshut != other.is_buyshut) {
      return false;
    }
    if (this->is_attackqs != other.is_attackqs) {
      return false;
    }
    return true;
  }
