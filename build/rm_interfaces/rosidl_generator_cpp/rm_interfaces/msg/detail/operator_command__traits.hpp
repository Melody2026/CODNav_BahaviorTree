  ...
  std::ostream & out)
{
  ...
  {
    out << "is_spin: ";
    rosidl_generator_traits::value_to_yaml(msg.is_spin, out);
    out << ", ";
  }
  ...
  {
    out << "is_buyshut: ";
    rosidl_generator_traits::value_to_yaml(msg.is_buyshut, out);
    out << ", ";
  }
  ...
  {
    out << "is_attackqs: ";
    rosidl_generator_traits::value_to_yaml(msg.is_attackqs, out);
  }
  out << "}";
