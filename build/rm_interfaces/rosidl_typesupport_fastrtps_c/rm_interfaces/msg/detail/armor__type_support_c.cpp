  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_interfaces__msg__Armor * ros_message = static_cast<const rm_interfaces__msg__Armor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_interfaces__msg__Armor(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_interfaces__msg__Armor * ros_message = static_cast<rm_interfaces__msg__Armor *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_interfaces__msg__Armor(cdr, ros_message);
}
