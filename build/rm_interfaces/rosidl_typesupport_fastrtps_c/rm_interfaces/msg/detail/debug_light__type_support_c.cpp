...
#include "rm_interfaces/msg/detail/debug_light__rosidl_typesupport_fastrtps_c.h"
...
using _DebugLight__ros_msg_type = rm_interfaces__msg__DebugLight;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces__msg__DebugLight;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_interfaces__msg__DebugLight * ros_message = static_cast<const rm_interfaces__msg__DebugLight *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_interfaces__msg__DebugLight(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_interfaces__msg__DebugLight * ros_message = static_cast<rm_interfaces__msg__DebugLight *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_interfaces__msg__DebugLight(cdr, ros_message);
}

static uint32_t _DebugLight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rm_interfaces__msg__DebugLight(
...
static size_t _DebugLight__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rm_interfaces__msg__DebugLight(
