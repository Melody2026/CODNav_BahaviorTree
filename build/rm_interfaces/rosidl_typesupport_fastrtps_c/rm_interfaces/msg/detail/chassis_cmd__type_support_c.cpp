...
bool cdr_serialize_rm_interfaces__msg__ChassisCmd(
  const rm_interfaces__msg__ChassisCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
bool cdr_deserialize_rm_interfaces__msg__ChassisCmd(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces__msg__ChassisCmd * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
bool cdr_serialize_key_rm_interfaces__msg__ChassisCmd(
  const rm_interfaces__msg__ChassisCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
size_t get_serialized_size_key_rm_interfaces__msg__ChassisCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ChassisCmd__ros_msg_type * ros_message = static_cast<const _ChassisCmd__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rm_interfaces
size_t max_serialized_size_key_rm_interfaces__msg__ChassisCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rm_interfaces__msg__ChassisCmd * ros_message = static_cast<const rm_interfaces__msg__ChassisCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rm_interfaces__msg__ChassisCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rm_interfaces__msg__ChassisCmd * ros_message = static_cast<rm_interfaces__msg__ChassisCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rm_interfaces__msg__ChassisCmd(cdr, ros_message);
}
