...
// IWYU pragma: private, include "rm_interfaces/msg/gimbal_cmd.hpp"
...
class Init_GimbalCmd_aim_id
{
public:
  explicit Init_GimbalCmd_aim_id(::rm_interfaces::msg::GimbalCmd & msg)
  : msg_(msg)
  {}
  ::rm_interfaces::msg::GimbalCmd aim_id(::rm_interfaces::msg::GimbalCmd::_aim_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_GimbalCmd_aim_id fire_advice(::rm_interfaces::msg::GimbalCmd::_fire_advice_type arg)
  {
    msg_.fire_advice = std::move(arg);
    return Init_GimbalCmd_aim_id(msg_);
  }
