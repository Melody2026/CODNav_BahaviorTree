...
// IWYU pragma: private, include "rm_interfaces/msg/target.hpp"
...
{
public:
  explicit Init_Target_dz(::rm_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_yaw_diff dz(::rm_interfaces::msg::Target::_dz_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_dz radius_2(::rm_interfaces::msg::Target::_radius_2_type arg)
  {
