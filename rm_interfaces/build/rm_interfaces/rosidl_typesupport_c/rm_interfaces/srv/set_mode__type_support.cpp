...
static const _SetMode_Event_type_support_symbol_names_t _SetMode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rm_interfaces, srv, SetMode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, srv, SetMode_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rm_interfaces, srv, SetMode_Event)() {
  return &::rm_interfaces::srv::rosidl_typesupport_c::SetMode_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetMode_service_type_support_handle = {
  ...
  &SetMode_Request_message_type_support_handle,
  &SetMode_Response_message_type_support_handle,
  &SetMode_Event_message_type_support_handle,
