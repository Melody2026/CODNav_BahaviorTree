...
#include "rm_interfaces/msg/detail/point2d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_interfaces::msg::Point2d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::Point2d & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::Point2d;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::Point2d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::Point2d *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Point2d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, Point2d)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_Point2d__handle;
}
