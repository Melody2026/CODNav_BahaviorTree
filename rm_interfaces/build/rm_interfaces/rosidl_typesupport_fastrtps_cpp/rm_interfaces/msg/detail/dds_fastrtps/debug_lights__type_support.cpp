...
#include "rm_interfaces/msg/detail/debug_lights__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const rm_interfaces::msg::DebugLight &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  rm_interfaces::msg::DebugLight &);
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_DebugLight(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const rm_interfaces::msg::DebugLights & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::DebugLights & ros_message)
{
  // Member: data
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rm_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DebugLight(
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::DebugLights;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_rm_interfaces
max_serialized_size_key_DebugLights(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: data
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        rm_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_DebugLight(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::DebugLights *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::DebugLights *>(
    untyped_ros_message);
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_DebugLights__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, DebugLights)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_DebugLights__handle;
}
