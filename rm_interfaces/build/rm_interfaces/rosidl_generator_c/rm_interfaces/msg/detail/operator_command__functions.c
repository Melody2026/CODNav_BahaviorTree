...
rm_interfaces__msg__OperatorCommand__are_equal(const rm_interfaces__msg__OperatorCommand * lhs, const rm_interfaces__msg__OperatorCommand * rhs)
{
  ...
  // is_spin
  if (lhs->is_spin != rhs->is_spin) {
    return false;
  }
  // is_buyshut
  if (lhs->is_buyshut != rhs->is_buyshut) {
    return false;
  }
  // is_attackqs
  if (lhs->is_attackqs != rhs->is_attackqs) {
    return false;
  }
  return true;
}
  ...
  rm_interfaces__msg__OperatorCommand * output)
{
  ...
  // is_spin
  output->is_spin = input->is_spin;
  // is_buyshut
  output->is_buyshut = input->is_buyshut;
  // is_attackqs
  output->is_attackqs = input->is_attackqs;
  return true;
}

rm_interfaces__msg__OperatorCommand *
rm_interfaces__msg__OperatorCommand__create(void)
{
