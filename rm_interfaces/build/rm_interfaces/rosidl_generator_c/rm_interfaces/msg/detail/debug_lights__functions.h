...
// IWYU pragma: private, include "rm_interfaces/msg/debug_lights.h"


#ifndef RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHTS__FUNCTIONS_H_
#define RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHTS__FUNCTIONS_H_
 ...
 * calls
 * rm_interfaces__msg__DebugLights__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rm_interfaces
rm_interfaces__msg__DebugLights *
rm_interfaces__msg__DebugLights__create(void);

/// Destroy msg/DebugLights message.
/**
 * It calls
 * rm_interfaces__msg__DebugLights__fini()
 ...
 * rm_interfaces__msg__DebugLights__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rm_interfaces__msg__DebugLights__Sequence__fini()
 * on the array,
...
#endif  // RM_INTERFACES__MSG__DETAIL__DEBUG_LIGHTS__FUNCTIONS_H_
