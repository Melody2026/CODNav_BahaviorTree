...
rm_interfaces__msg__EkfP__create(void)
{
  ...
  rm_interfaces__msg__EkfP * msg = (rm_interfaces__msg__EkfP *)allocator.allocate(sizeof(rm_interfaces__msg__EkfP), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(rm_interfaces__msg__EkfP));
  bool success = rm_interfaces__msg__EkfP__init(msg);
  if (!success) {
...
rm_interfaces__msg__EkfP__destroy(rm_interfaces__msg__EkfP * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    rm_interfaces__msg__EkfP__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
rm_interfaces__msg__EkfP__Sequence__init(rm_interfaces__msg__EkfP__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interfaces__msg__EkfP * data = NULL;

  if (size) {
    data = (rm_interfaces__msg__EkfP *)allocator.zero_allocate(size, sizeof(rm_interfaces__msg__EkfP), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = rm_interfaces__msg__EkfP__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        rm_interfaces__msg__EkfP__fini(&data[i - 1]);
      }
...
rm_interfaces__msg__EkfP__Sequence__fini(rm_interfaces__msg__EkfP__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      rm_interfaces__msg__EkfP__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  rm_interfaces__msg__EkfP__Sequence * array = (rm_interfaces__msg__EkfP__Sequence *)allocator.allocate(sizeof(rm_interfaces__msg__EkfP__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = rm_interfaces__msg__EkfP__Sequence__init(array, size);
  if (!success) {
...
rm_interfaces__msg__EkfP__Sequence__destroy(rm_interfaces__msg__EkfP__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    rm_interfaces__msg__EkfP__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
rm_interfaces__msg__EkfP__Sequence__are_equal(const rm_interfaces__msg__EkfP__Sequence * lhs, const rm_interfaces__msg__EkfP__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!rm_interfaces__msg__EkfP__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  rm_interfaces__msg__EkfP__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(rm_interfaces__msg__EkfP);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    rm_interfaces__msg__EkfP * data =
      (rm_interfaces__msg__EkfP *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__msg__EkfP__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          rm_interfaces__msg__EkfP__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!rm_interfaces__msg__EkfP__copy(
