...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SerialReceiveData_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<rm_interfaces::msg::JudgeSystemData>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::SerialReceiveData, judge_system_data),  // bytes offset in struct
