...
{
  new (message_memory) rm_interfaces::msg::DebugLight(_init);
}

void DebugLight_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rm_interfaces::msg::DebugLight *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DebugLight_message_member_array[4] = {
  {
    ...
    offsetof(rm_interfaces::msg::DebugLight, center_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::DebugLight, is_light),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::DebugLight, ratio),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces::msg::DebugLight, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DebugLight_message_members = {
  ...
  4,  // number of fields
  sizeof(rm_interfaces::msg::DebugLight),
...
get_message_type_support_handle<rm_interfaces::msg::DebugLight>()
{
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::DebugLight_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rm_interfaces, msg, DebugLight)() {
  return &::rm_interfaces::msg::rosidl_typesupport_introspection_cpp::DebugLight_message_type_support_handle;
}
