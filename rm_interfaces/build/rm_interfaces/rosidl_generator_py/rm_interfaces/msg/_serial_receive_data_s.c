...
bool rm_interfaces__msg__serial_receive_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // judge_system_data
    ...
    if (!rm_interfaces__msg__judge_system_data__convert_from_py(field, &ros_message->judge_system_data)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * rm_interfaces__msg__serial_receive_data__convert_to_py(void * raw_ros_message)
{
  ...
  {  // judge_system_data
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "judge_system_data", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
