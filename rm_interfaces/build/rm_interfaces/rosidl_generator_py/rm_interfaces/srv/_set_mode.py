...
class SetMode_Event(metaclass=Metaclass_SetMode_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<rm_interfaces/SetMode_Request, 1>',
        'response': 'sequence<rm_interfaces/SetMode_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rm_interfaces', 'srv'], 'SetMode_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['rm_interfaces', 'srv'], 'SetMode_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from rm_interfaces.srv import SetMode_Request
    ...
    def response(self, value):
        if self._check_fields:
            from rm_interfaces.srv import SetMode_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetMode(metaclass=Metaclass_SetMode):
    ...
    from rm_interfaces.srv._set_mode import SetMode_Event as Event
